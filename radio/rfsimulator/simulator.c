...
//#define CirSize 460800 // 10ms  SiSo 40Mhz 3/4 sampling NR78 FR1 //Joshua changed CirSize to 61440000 in next line

#define CirSize 61440000 //Joshua changed CirSize to 61440000
...
extern uint64_t RFsim_PropDelay; //Joshua added this line
      ...
      for (int a=0; a<nbAnt; a++) {//loop over number of Rx antennas
        if ( ptr->channel_model != NULL ) { // apply a channel model
          rxAddInput(ptr->circularBuf, (c16_t *) samplesVoid[a],
                     ...
                     nsamps,
                     //t->nextRxTstamp,
                     t->nextRxTstamp-RFsim_PropDelay, //Joshua added this line
                     CirSize);
        }
